...
//
// 聊天頁右欄「玩家設定」分頁（第八節 + V2 頭貼上傳）。
// playerName、playerDescription、頭貼（emoji 或上傳圖片）。儲存後更新 state.player。
...
export function renderPlayerEditor(container, state) {
  ...
  const avatarInput = buildAvatarInput(player.avatar);
